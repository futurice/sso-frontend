...
try {
    ...
    function login_ping_update(is_event) {
        ...
        login_ping_image.src = "SCHEME://DOMAIN/ping/external/img?location="+encodeURIComponent(window.location)+"&t="+(new Date()).getTime()+"&activity="+login_window_current_status+"&hidden="+hidden+"&c="+login_ping_counter+"&r="+tab_id+"&u="+user_activity;
    ...
    i = new Image();
    i.src = "SCHEME://DOMAIN/ping/external/img?location="+encodeURIComponent(window.location)+"&t="+(new Date()).getTime()+"&error="+encodeURIComponent(""+e);
}
})();
