...
RUN apt-get update && apt-get install -y \
    ...
    redis-server libmysqlclient-dev zlib1g libjpeg-dev
...
RUN wget -qO /opt/app/sso_frontend/data/maxmind.gz http://geolite.maxmind.com/download/geoip/database/GeoLite2-City.mmdb.gz \
    && gzip -d maxmind.gz
